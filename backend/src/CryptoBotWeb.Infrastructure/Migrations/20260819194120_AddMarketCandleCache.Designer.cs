...
namespace CryptoBotWeb.Infrastructure.Migrations
{
    ...
    [Migration("20260819194120_AddMarketCandleCache")]
    partial class AddMarketCandleCache
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoBotWeb.Core.Entities.BalanceSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CryptoBotWeb.Core.Entities.ExchangeAccount", b =>
                {
                    ...
                    b.Property<string>("DzengiAccountId")
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("CryptoBotWeb.Core.Entities.ExchangeAccountProxy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AccountId", "ProxyId")
                        .IsUnique();

                    b.ToTable("exchange_account_proxies", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoBotWeb.Core.Entities.MarketCandle", b =>
                {
                    ...
                    b.HasKey("ExchangeType", "Symbol", "Timeframe", "OpenTime");

                    b.ToTable("market_candles", (string)null);
                });

            modelBuilder.Entity("CryptoBotWeb.Core.Entities.MarketCandleRange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ExchangeType", "Symbol", "Timeframe");

                    b.ToTable("market_candle_ranges", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoBotWeb.Core.Entities.TelegramSubscriber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TelegramBotId", "ChatId")
                        .IsUnique();

                    b.ToTable("telegram_subscribers", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoBotWeb.Core.Entities.Strategy", b =>
                {
                    ...
                    b.HasOne("CryptoBotWeb.Core.Entities.ExchangeAccount", "SecondAccount")
                        .WithMany()
                        .HasForeignKey("SecondAccountId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CryptoBotWeb.Core.Entities.TelegramBot", "TelegramBot")
                        .WithMany("Strategies")
